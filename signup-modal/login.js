function openModal() {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (myInput.value<confirmMyInput.value?0:(myInput.value>confirmMyInput.value?0:1)); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
